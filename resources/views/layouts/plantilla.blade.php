...
<body style = "font-family: 'Caveat', cursive;">
    ...
    <header>
      ...
      <div class="flex justify-center items-center h-full">
        <div class="text-center text-white px-6 md:px-12">
          <h1 class="text-8xl font-bold mt-0 mb-6">QUIDDITCH APP</h1>
          <h3 class="text-2xl mb-8">Tu aplicación de gestión de equipos y partidos</h3>
    ...
    <footer class="text-center text-black" style="background-color: #f1f1f1;">
            ...
            <div class="flex justify-center mb-9 h-1">
      <a href="https://github.com/marcamvi" class="text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
  ...
  <div class="text-center text-gray-700 h-5" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2021 Copyright:
